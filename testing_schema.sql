...
LOAD DATA LOCAL INFILE '~/Online_Booking_Store/publisher.csv' INTO TABLE `PUBLISHER` FIELDS TERMINATED BY ',' LINES TERMINATED BY '\n';
LOAD DATA LOCAL INFILE '~/Online_Booking_Store/book.csv' INTO TABLE `BOOK` FIELDS TERMINATED BY ',' LINES TERMINATED BY '\n';
LOAD DATA LOCAL INFILE '~/Online_Booking_Store/book_authors.csv' INTO TABLE `BOOK_AUTHORS` FIELDS TERMINATED BY ',' LINES TERMINATED BY '\n';
